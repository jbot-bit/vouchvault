...
export function buildPinnedGuideText(): string {
  return [
    ...
    "",
    "<b><u>Check before you deal</u></b>",
    "Use the search bar at the top of this group to look up anyone's @username. Run <code>/lookup @username</code> in-group or DM, or type <code>@VouchVaultBot @username</code> anywhere to drop a vouch card inline.",
    "",
    "<b><u>Spotting fakes</u></b>",
    "Real vouch cards say <i>via @VouchVaultBot</i> under the sender's name. Anything that looks like a card without that tag is fake — DM an admin.",
    "",
    "<b><u>Chat moderation</u></b>",
    "Posts that look like buy/sell arrangements are auto-removed. Contact an admin if you think this happened in error.",
    "Send <code>/start</code> to me once so I can DM you if a post of yours is removed.",
